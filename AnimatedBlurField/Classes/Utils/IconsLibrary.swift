...
class IconsLibrary: NSObject {
    ...
    class func drawEye(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 24, height: 24), resizing: ResizingBehavior = .aspectFit, color: UIColor = .white) {
    ...
    class func drawEyeoff(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 24, height: 24), resizing: ResizingBehavior = .aspectFit, color: UIColor = .white) {
        /// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    class func imageOfEye(color: UIColor = .white, size: CGSize = CGSize(width: 26, height: 26)) -> UIImage {
        /*struct LocalCache {
    ...
    class func imageOfEyeoff(color: UIColor = .white, size: CGSize = CGSize(width: 26, height: 26)) -> UIImage {
        /*struct LocalCache {
            static var image: UIImage!
        }
        if LocalCache.image != nil {
