//
//  AnimatedBlurField+Protocols.swift
//  FashTime
//
...
public protocol AnimatedBlurFieldDataSource: class {
    ...
    /**
     ...
     - returns: boolean
     */
    func animatedField(_ animatedField: AnimatedBlurField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool?
    ...
    /**
     ...
     - returns: boolean
     */
    func animatedFieldShouldReturn(_ animatedField: AnimatedBlurField) -> Bool
     ...
     */
    func animatedFieldTypingMatches(_ animatedField: AnimatedBlurField) -> String?
    ...
    /**
     ...
     - returns: regular expression you want to apply to this field
     */
    func animatedFieldValidationMatches(_ animatedField: AnimatedBlurField) -> String?
    ...
    */
    ...
    /**
     ...
     - returns: validation error message
     */
    func animatedFieldPriceExceededError(_ animatedField: AnimatedBlurField) -> String?
}

public extension AnimatedBlurFieldDataSource {
...
public protocol AnimatedBlurFieldDelegate: class {
